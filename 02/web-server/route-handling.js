...
const routes = {
	...
	'/api': (req, res) => {
		...
		res.end(JSON.stringify({
			...
			query: req.X_requestUrl.query // Mostrar los parámetros enviados
			// en la respuesta.
		}));
	},
	notFound: (req, res) => {
...
function handleRequest(req, res) {
	...
	// Es posible asignar propiedades al objeto Request para utilizarlas
	// posteriormente en los handlers.
	// Esto es útil cuando el valor será utilizado más de una vez.
	// Es considerado buena practica agregar un prefijo para evitar sobre
	// escribir propiedades utilizadas por Node.js (o por el framework utilizado).
